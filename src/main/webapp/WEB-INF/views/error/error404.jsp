...
<style>
    ...
    * {margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif;}
    ...
    .container {position: absolute; top: 10%; left: 10%; right: 10%; bottom: 10%; display: flex; justify-content: center; align-items: center; background: url("/resources/static/image/error.png"), #151729; box-shadow: 0 15px 30px rgba(0,0,0,.5); border-radius: 10px;}
...
<body>
    <div class="container">
        <div class="content">
            ...
            <a href="/login">로그인 화면 이동</a> <!-- 로그인 버튼 누르면 로그인 페이지로 이동 -->
        </div>
    </div>
</body>
</html>